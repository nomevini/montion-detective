...
"}")
        ...
        # Criando o botão para abrir a pasta de resultados
        self.pushButton_open_folder = QtWidgets.QPushButton(self.frame_4)
        self.pushButton_open_folder.setText("Abrir Pasta de Resultados")
        self.pushButton_open_folder.setSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        self.pushButton_open_folder.setMinimumSize(QtCore.QSize(200, 50))
        self.pushButton_open_folder.setStyleSheet("QPushButton{\n"
        ...
        self.horizontalLayout_3.addWidget(self.pushButton_open_folder, 0, QtCore.Qt.AlignLeft)
...
"}")
        ...
        # Código existente para o checkbox
